...
osMessageQId Queue_receiveHandle;
...
/* USER CODE BEGIN Header_Task_Viseur */
/**
* @brief Function implementing the viseur thread.
* @param argument: Not used
* @retval None
*/
...
void Task_Viseur(void const * argument)
{
  ...
  /* USER CODE END Task_Viseur */
}

/* USER CODE BEGIN Header_Task_Tir */
/**
* @brief Function implementing the tir thread.
* @param argument: Not used
* @retval None
*/
...
/* USER CODE BEGIN Header_Task_Share */
/**
* @brief Function implementing the share thread.
* @param argument: Not used
* @retval None
*/
